...
import { setConnectedUsers, setUserLastSeen } from "../redux/slicers/connectedUsers";
...
export const SocketsContextProvider = ({ children }) => {
    ...
    const sendNotificationHandler = useCallback(({ from, to }) => {
    ...
    useEffect(() => {
        if (socket) {
            ...
            socket.on("get:lastSeen", (lastSeen) => {
                dispatch(setUserLastSeen(lastSeen));
            });
    ...
    return <SocketsContext.Provider value={value}>
        {children}
