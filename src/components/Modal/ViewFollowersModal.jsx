...
function ViewFollowersModal({ isOpen, onClose, data }) {
  ...
  return (
    <div className="  fixed top-0 left-0 bg-black/40 right-0 bottom-0 flex items-center justify-center z-[9999]">
      <div className=" md:h-3/4 h-full w-full md:pt-4 pt-16 flex flex-col gap-2 bg-black/20 dark:bg-white/50 backdrop-blur-sm md:w-1/3 p-2 md:rounded-lg overflow-y-auto ">
        {results.length > 0 ? (
